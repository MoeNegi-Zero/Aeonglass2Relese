...
public sealed class AeonglassBossV107 : EncounterModel
{
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters => [ModelDb.Monster<AeonglassV107>()];
	...
	{
		return [(ModelDb.Monster<AeonglassV107>().ToMutable(), null)];
	}
}
