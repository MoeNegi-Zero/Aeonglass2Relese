...
public sealed class WitheringPresencePowerV106 : PowerModel
{
	...
	protected override IEnumerable<IHoverTip> ExtraHoverTips => HoverTipFactory.FromCardWithCardHoverTips<WitherV106>();
