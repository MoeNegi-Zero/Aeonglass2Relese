...
public sealed class AeonglassV107 : MonsterModel
{
    ...
    private async Task IncreasingIntensityMove(IReadOnlyList<Creature> targets)
    {
        foreach (Creature target in targets)
        {
            ...
            {
                if (allCard is WitherV106 wither)
                {
                    wither.FakeUpgrade();
                }
            }
    ...
    public void MatchWitherToUpgradeCount(WitherV106 wither)
    {
